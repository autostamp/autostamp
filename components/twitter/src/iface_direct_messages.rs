...
fn iface_direct_messages__place_type__to_str(e: &iface_direct_messages::PlaceType) -> &'static str {
    match e {
        iface_direct_messages::PlaceType::Poi => "poi",
        iface_direct_messages::PlaceType::Neighborhood => "neighborhood",
        iface_direct_messages::PlaceType::City => "city",
        iface_direct_messages::PlaceType::Admin => "admin",
        iface_direct_messages::PlaceType::Country => "country",
        iface_direct_messages::PlaceType::Unknown => "unknown",
    }
}
...
fn iface_direct_messages__reply_settings__to_str(e: &iface_direct_messages::ReplySettings) -> &'static str {
    match e {
        iface_direct_messages::ReplySettings::Everyone => "everyone",
        iface_direct_messages::ReplySettings::MentionedUsers => "mentionedUsers",
        iface_direct_messages::ReplySettings::Following => "following",
        iface_direct_messages::ReplySettings::Other => "other",
    }
}
...
fn iface_direct_messages__create_dm_event_response_data__to_json(p: &iface_direct_messages::CreateDmEventResponseData) -> Value {
    ...
    m.insert("dm_event_id".into(), Value::String((&p.dm_event_id).clone()));
    Value::Object(m)
}
...
fn iface_direct_messages__dm_event__to_json(p: &iface_direct_messages::DmEvent) -> Value {
    ...
    m.insert("dm_conversation_id".into(), match (&p.dm_conversation_id) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("event_type".into(), Value::String((&p.event_type).clone()));
    m.insert("id".into(), Value::String((&p.id).clone()));
    m.insert("participant_ids".into(), match (&p.participant_ids) { Some(v) => Value::Array((v).iter().map(|v| Value::String((v).clone())).collect()), None => Value::Null });
    ...
    m.insert("sender_id".into(), match (&p.sender_id) { Some(v) => Value::String((v).clone()), None => Value::Null });
...
fn iface_direct_messages__place__to_json(p: &iface_direct_messages::Place) -> Value {
    ...
    m.insert("place_type".into(), match (&p.place_type) { Some(v) => Value::String(iface_direct_messages__place_type__to_str(v).into()), None => Value::Null });
    Value::Object(m)
}
...
fn iface_direct_messages__geo_properties_entry__to_json(p: &iface_direct_messages::GeoPropertiesEntry) -> Value {
    let mut m = Map::new();
...
fn iface_direct_messages__tweet__to_json(p: &iface_direct_messages::Tweet) -> Value {
    ...
    m.insert("reply_settings".into(), match (&p.reply_settings) { Some(v) => Value::String(iface_direct_messages__reply_settings__to_str(v).into()), None => Value::Null });
...
fn iface_direct_messages__dm_conversation_id_create_params__to_json(p: &iface_direct_messages::DmConversationIdCreateParams) -> Value {
    ...
    m.insert("participant_ids".into(), Value::Array((&p.participant_ids).iter().map(|v| Value::String((v).clone())).collect()));
    Value::Object(m)
}
...
fn iface_direct_messages__create_dm_event_response_data__from_json(v: &Value) -> Option<iface_direct_messages::CreateDmEventResponseData> {
    ...
    Some(iface_direct_messages::CreateDmEventResponseData {
        dm_conversation_id: m.get("dm_conversation_id").and_then(|v| (v).as_str().map(|s| s.to_string())).unwrap_or_default(),
        dm_event_id: m.get("dm_event_id").and_then(|v| (v).as_str().map(|s| s.to_string())).unwrap_or_default(),
    })
}
...
fn iface_direct_messages__dm_event__from_json(v: &Value) -> Option<iface_direct_messages::DmEvent> {
    ...
    Some(iface_direct_messages::DmEvent {
        ...
        dm_conversation_id: m.get("dm_conversation_id").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        event_type: m.get("event_type").and_then(|v| (v).as_str().map(|s| s.to_string())).unwrap_or_default(),
        id: m.get("id").and_then(|v| (v).as_str().map(|s| s.to_string())).unwrap_or_default(),
        participant_ids: m.get("participant_ids").filter(|v| !v.is_null()).and_then(|v| (v).as_array().map(|a| a.iter().filter_map(|x| (x).as_str().map(|s| s.to_string())).collect())),
        ...
        sender_id: m.get("sender_id").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
...
fn iface_direct_messages__place__from_json(v: &Value) -> Option<iface_direct_messages::Place> {
    ...
    Some(iface_direct_messages::Place {
        ...
        place_type: m.get("place_type").filter(|v| !v.is_null()).and_then(|v| (v).as_str().and_then(iface_direct_messages__place_type__from_str)),
    })
}
...
fn iface_direct_messages__geo__from_json(v: &Value) -> Option<iface_direct_messages::Geo> {
    ...
    Some(iface_direct_messages::Geo {
        ...
        properties: m.get("properties").and_then(|v| (v).as_object().map(|o| o.iter().filter_map(|(k, x)| ((x).as_str().map(|s| s.to_string())).map(|val| iface_direct_messages::GeoPropertiesEntry { key: k.clone(), value: val })).collect())).unwrap_or_default(),
...
fn iface_direct_messages__geo_properties_entry__from_json(v: &Value) -> Option<iface_direct_messages::GeoPropertiesEntry> {
    let m = v.as_object()?;
    Some(iface_direct_messages::GeoPropertiesEntry {
...
fn iface_direct_messages__tweet__from_json(v: &Value) -> Option<iface_direct_messages::Tweet> {
    ...
    Some(iface_direct_messages::Tweet {
        ...
        reply_settings: m.get("reply_settings").filter(|v| !v.is_null()).and_then(|v| (v).as_str().and_then(iface_direct_messages__reply_settings__from_str)),
...
fn iface_direct_messages__place_type__from_str(s: &str) -> Option<iface_direct_messages::PlaceType> {
    match s {
        "poi" => Some(iface_direct_messages::PlaceType::Poi),
        "neighborhood" => Some(iface_direct_messages::PlaceType::Neighborhood),
        "city" => Some(iface_direct_messages::PlaceType::City),
        "admin" => Some(iface_direct_messages::PlaceType::Admin),
        "country" => Some(iface_direct_messages::PlaceType::Country),
        "unknown" => Some(iface_direct_messages::PlaceType::Unknown),
        _ => None,
    }
}
...
fn iface_direct_messages__reply_settings__from_str(s: &str) -> Option<iface_direct_messages::ReplySettings> {
    match s {
        "everyone" => Some(iface_direct_messages::ReplySettings::Everyone),
        "mentionedUsers" => Some(iface_direct_messages::ReplySettings::MentionedUsers),
        "following" => Some(iface_direct_messages::ReplySettings::Following),
        "other" => Some(iface_direct_messages::ReplySettings::Other),
        _ => None,
    }
}
