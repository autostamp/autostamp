...
const OP_REQUEST_TAG_GET_APOD: OpSpec = OpSpec {
    ...
    fields: &[
        ...
        FieldSpec { snake: "hd", location: FieldLocation::Query },
    ],
    auth: &[
...
impl iface_request_tag::Guest for crate::Component {
    fn get_apod(params: iface_request_tag::GetApodParams) -> Result<String, String> {
        let json = iface_request_tag__get_apod_params__to_json(&params);
        dispatch(&OP_REQUEST_TAG_GET_APOD, json)
    }
}
