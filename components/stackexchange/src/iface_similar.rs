...
fn iface_similar__questions_item__to_json(p: &iface_similar::QuestionsItem) -> Value {
    let mut m = Map::new();
    ...
    m.insert("bounty_user".into(), match (&p.bounty_user) { Some(v) => iface_similar__questions_item_bounty_user__to_json(v), None => Value::Null });
    ...
    m.insert("closed_details".into(), match (&p.closed_details) { Some(v) => iface_similar__questions_item_closed_details__to_json(v), None => Value::Null });
    ...
    m.insert("last_editor".into(), match (&p.last_editor) { Some(v) => iface_similar__questions_item_last_editor__to_json(v), None => Value::Null });
    ...
    m.insert("migrated_from".into(), match (&p.migrated_from) { Some(v) => iface_similar__questions_item_migrated_from__to_json(v), None => Value::Null });
    m.insert("migrated_to".into(), match (&p.migrated_to) { Some(v) => iface_similar__questions_item_migrated_to__to_json(v), None => Value::Null });
    m.insert("notice".into(), match (&p.notice) { Some(v) => iface_similar__questions_item_notice__to_json(v), None => Value::Null });
    m.insert("owner".into(), match (&p.owner) { Some(v) => iface_similar__questions_item_owner__to_json(v), None => Value::Null });
...
fn iface_similar__questions_item_bounty_user__to_json(p: &iface_similar::QuestionsItemBountyUser) -> Value {
    let mut m = Map::new();
    m.insert("accept_rate".into(), match (&p.accept_rate) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("badge_counts".into(), match (&p.badge_counts) { Some(v) => iface_similar__questions_item_bounty_user_badge_counts__to_json(v), None => Value::Null });
...
fn iface_similar__questions_item_bounty_user_badge_counts__to_json(p: &iface_similar::QuestionsItemBountyUserBadgeCounts) -> Value {
    let mut m = Map::new();
...
fn iface_similar__questions_item_closed_details__to_json(p: &iface_similar::QuestionsItemClosedDetails) -> Value {
    let mut m = Map::new();
...
fn iface_similar__questions_item_last_editor__to_json(p: &iface_similar::QuestionsItemLastEditor) -> Value {
    let mut m = Map::new();
    m.insert("accept_rate".into(), match (&p.accept_rate) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("badge_counts".into(), match (&p.badge_counts) { Some(v) => iface_similar__questions_item_last_editor_badge_counts__to_json(v), None => Value::Null });
    m.insert("display_name".into(), match (&p.display_name) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("link".into(), match (&p.link) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("profile_image".into(), match (&p.profile_image) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("reputation".into(), match (&p.reputation) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
...
fn iface_similar__questions_item_last_editor_badge_counts__to_json(p: &iface_similar::QuestionsItemLastEditorBadgeCounts) -> Value {
    let mut m = Map::new();
    m.insert("bronze".into(), match (&p.bronze) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("gold".into(), match (&p.gold) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("silver".into(), match (&p.silver) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
...
fn iface_similar__questions_item_migrated_from__to_json(p: &iface_similar::QuestionsItemMigratedFrom) -> Value {
    let mut m = Map::new();
    m.insert("on_date".into(), match (&p.on_date) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("other_site".into(), match (&p.other_site) { Some(v) => iface_similar__questions_item_migrated_from_other_site__to_json(v), None => Value::Null });
    m.insert("question_id".into(), match (&p.question_id) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    Value::Object(m)
}

fn iface_similar__questions_item_migrated_from_other_site__to_json(p: &iface_similar::QuestionsItemMigratedFromOtherSite) -> Value {
    let mut m = Map::new();
    ...
    m.insert("styling".into(), match (&p.styling) { Some(v) => iface_similar__questions_item_migrated_from_other_site_styling__to_json(v), None => Value::Null });
    m.insert("twitter_account".into(), match (&p.twitter_account) { Some(v) => Value::String((v).clone()), None => Value::Null });
    Value::Object(m)
}

fn iface_similar__questions_item_migrated_from_other_site_styling__to_json(p: &iface_similar::QuestionsItemMigratedFromOtherSiteStyling) -> Value {
    let mut m = Map::new();
...
fn iface_similar__questions_item_migrated_to__to_json(p: &iface_similar::QuestionsItemMigratedTo) -> Value {
    let mut m = Map::new();
    m.insert("on_date".into(), match (&p.on_date) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("other_site".into(), match (&p.other_site) { Some(v) => iface_similar__questions_item_migrated_to_other_site__to_json(v), None => Value::Null });
    m.insert("question_id".into(), match (&p.question_id) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    Value::Object(m)
}

fn iface_similar__questions_item_migrated_to_other_site__to_json(p: &iface_similar::QuestionsItemMigratedToOtherSite) -> Value {
    let mut m = Map::new();
    m.insert("aliases".into(), match (&p.aliases) { Some(v) => Value::Array((v).iter().map(|v| Value::String((v).clone())).collect()), None => Value::Null });
    m.insert("api_site_parameter".into(), match (&p.api_site_parameter) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("audience".into(), match (&p.audience) { Some(v) => Value::String((v).clone()), None => Value::Null });
    ...
    m.insert("site_type".into(), match (&p.site_type) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("site_url".into(), match (&p.site_url) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("styling".into(), match (&p.styling) { Some(v) => iface_similar__questions_item_migrated_to_other_site_styling__to_json(v), None => Value::Null });
    m.insert("twitter_account".into(), match (&p.twitter_account) { Some(v) => Value::String((v).clone()), None => Value::Null });
    Value::Object(m)
}

fn iface_similar__questions_item_migrated_to_other_site_styling__to_json(p: &iface_similar::QuestionsItemMigratedToOtherSiteStyling) -> Value {
    let mut m = Map::new();
    m.insert("link_color".into(), match (&p.link_color) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("tag_background_color".into(), match (&p.tag_background_color) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("tag_foreground_color".into(), match (&p.tag_foreground_color) { Some(v) => Value::String((v).clone()), None => Value::Null });
...
fn iface_similar__questions_item_notice__to_json(p: &iface_similar::QuestionsItemNotice) -> Value {
    let mut m = Map::new();
    m.insert("body".into(), match (&p.body) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("creation_date".into(), match (&p.creation_date) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
...
fn iface_similar__questions_item_owner__to_json(p: &iface_similar::QuestionsItemOwner) -> Value {
    let mut m = Map::new();
    m.insert("accept_rate".into(), match (&p.accept_rate) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("badge_counts".into(), match (&p.badge_counts) { Some(v) => iface_similar__questions_item_owner_badge_counts__to_json(v), None => Value::Null });
    m.insert("display_name".into(), match (&p.display_name) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("link".into(), match (&p.link) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("profile_image".into(), match (&p.profile_image) { Some(v) => Value::String((v).clone()), None => Value::Null });
    m.insert("reputation".into(), match (&p.reputation) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
...
fn iface_similar__questions_item_owner_badge_counts__to_json(p: &iface_similar::QuestionsItemOwnerBadgeCounts) -> Value {
    let mut m = Map::new();
    m.insert("bronze".into(), match (&p.bronze) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("gold".into(), match (&p.gold) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
    m.insert("silver".into(), match (&p.silver) { Some(v) => Value::Number(serde_json::Number::from(*(v))), None => Value::Null });
...
fn iface_similar__questions_item__from_json(v: &Value) -> Option<iface_similar::QuestionsItem> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItem {
        ...
        bounty_user: m.get("bounty_user").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_bounty_user__from_json(v)),
        ...
        closed_details: m.get("closed_details").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_closed_details__from_json(v)),
        ...
        last_editor: m.get("last_editor").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_last_editor__from_json(v)),
        ...
        migrated_from: m.get("migrated_from").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_migrated_from__from_json(v)),
        migrated_to: m.get("migrated_to").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_migrated_to__from_json(v)),
        notice: m.get("notice").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_notice__from_json(v)),
        owner: m.get("owner").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_owner__from_json(v)),
...
fn iface_similar__questions_item_bounty_user__from_json(v: &Value) -> Option<iface_similar::QuestionsItemBountyUser> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemBountyUser {
        accept_rate: m.get("accept_rate").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        badge_counts: m.get("badge_counts").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_bounty_user_badge_counts__from_json(v)),
...
fn iface_similar__questions_item_bounty_user_badge_counts__from_json(v: &Value) -> Option<iface_similar::QuestionsItemBountyUserBadgeCounts> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemBountyUserBadgeCounts {
...
fn iface_similar__questions_item_closed_details__from_json(v: &Value) -> Option<iface_similar::QuestionsItemClosedDetails> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemClosedDetails {
...
fn iface_similar__questions_item_last_editor__from_json(v: &Value) -> Option<iface_similar::QuestionsItemLastEditor> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemLastEditor {
        accept_rate: m.get("accept_rate").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        badge_counts: m.get("badge_counts").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_last_editor_badge_counts__from_json(v)),
        display_name: m.get("display_name").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        link: m.get("link").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        profile_image: m.get("profile_image").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        reputation: m.get("reputation").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
...
fn iface_similar__questions_item_last_editor_badge_counts__from_json(v: &Value) -> Option<iface_similar::QuestionsItemLastEditorBadgeCounts> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemLastEditorBadgeCounts {
        bronze: m.get("bronze").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        gold: m.get("gold").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        silver: m.get("silver").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
    })
...
fn iface_similar__questions_item_migrated_from__from_json(v: &Value) -> Option<iface_similar::QuestionsItemMigratedFrom> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemMigratedFrom {
        on_date: m.get("on_date").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        other_site: m.get("other_site").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_migrated_from_other_site__from_json(v)),
        question_id: m.get("question_id").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
    })
}

fn iface_similar__questions_item_migrated_from_other_site__from_json(v: &Value) -> Option<iface_similar::QuestionsItemMigratedFromOtherSite> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemMigratedFromOtherSite {
        ...
        styling: m.get("styling").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_migrated_from_other_site_styling__from_json(v)),
        twitter_account: m.get("twitter_account").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
    })
}

fn iface_similar__questions_item_migrated_from_other_site_styling__from_json(v: &Value) -> Option<iface_similar::QuestionsItemMigratedFromOtherSiteStyling> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemMigratedFromOtherSiteStyling {
...
fn iface_similar__questions_item_migrated_to__from_json(v: &Value) -> Option<iface_similar::QuestionsItemMigratedTo> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemMigratedTo {
        on_date: m.get("on_date").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        other_site: m.get("other_site").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_migrated_to_other_site__from_json(v)),
        question_id: m.get("question_id").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
    })
}

fn iface_similar__questions_item_migrated_to_other_site__from_json(v: &Value) -> Option<iface_similar::QuestionsItemMigratedToOtherSite> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemMigratedToOtherSite {
        aliases: m.get("aliases").filter(|v| !v.is_null()).and_then(|v| (v).as_array().map(|a| a.iter().filter_map(|x| (x).as_str().map(|s| s.to_string())).collect())),
        api_site_parameter: m.get("api_site_parameter").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        audience: m.get("audience").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        closed_beta_date: m.get("closed_beta_date").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        ...
        site_type: m.get("site_type").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        site_url: m.get("site_url").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        styling: m.get("styling").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_migrated_to_other_site_styling__from_json(v)),
        twitter_account: m.get("twitter_account").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
    })
}

fn iface_similar__questions_item_migrated_to_other_site_styling__from_json(v: &Value) -> Option<iface_similar::QuestionsItemMigratedToOtherSiteStyling> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemMigratedToOtherSiteStyling {
        link_color: m.get("link_color").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        tag_background_color: m.get("tag_background_color").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        tag_foreground_color: m.get("tag_foreground_color").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
    })
...
fn iface_similar__questions_item_notice__from_json(v: &Value) -> Option<iface_similar::QuestionsItemNotice> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemNotice {
        body: m.get("body").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        creation_date: m.get("creation_date").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
...
fn iface_similar__questions_item_owner__from_json(v: &Value) -> Option<iface_similar::QuestionsItemOwner> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemOwner {
        accept_rate: m.get("accept_rate").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        badge_counts: m.get("badge_counts").filter(|v| !v.is_null()).and_then(|v| iface_similar__questions_item_owner_badge_counts__from_json(v)),
        display_name: m.get("display_name").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        link: m.get("link").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        profile_image: m.get("profile_image").filter(|v| !v.is_null()).and_then(|v| (v).as_str().map(|s| s.to_string())),
        reputation: m.get("reputation").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
...
fn iface_similar__questions_item_owner_badge_counts__from_json(v: &Value) -> Option<iface_similar::QuestionsItemOwnerBadgeCounts> {
    let m = v.as_object()?;
    Some(iface_similar::QuestionsItemOwnerBadgeCounts {
        bronze: m.get("bronze").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        gold: m.get("gold").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
        silver: m.get("silver").filter(|v| !v.is_null()).and_then(|v| (v).as_i64().map(|n| n as i32)),
    })
...
fn iface_similar__get_similar__ok(body: String) -> Result<Vec<iface_similar::QuestionsItem>, crate::runtime::DispatchError> {
    let v: Value = match serde_json::from_str(&body) {
        Ok(v) => v,
        Err(e) => return Err(crate::runtime::DispatchError::Transport(format!("failed to decode response body as JSON: {e}"))),
    };
    match (&v).as_array().map(|a| a.iter().filter_map(|x| iface_similar__questions_item__from_json(x)).collect()) {
        Some(x) => Ok(x),
...
impl iface_similar::Guest for crate::Component {
    fn get_similar(params: iface_similar::GetSimilarParams) -> Result<Vec<iface_similar::QuestionsItem>, iface_similar::GetSimilarError> {
